                        ...
                        <div class="px-4 py-5 sm:p-6">
                            <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ $application->full_name ?? 'Not provided' }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Email</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $application->email ?? 'Not provided' }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Phone</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $application->phone ?? 'Not provided' }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Experience</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $application->experience_years ?? 0 }} years</dd>
                                </div>
                                <div class="sm:col-span-2">
                                    <dt class="text-sm font-medium text-gray-500">Address</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $application->address ?? 'Not provided' }}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        ...
                        <div class="px-4 py-5 sm:p-6 space-y-4">
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900">{{ $application->skills ?? 'Not provided' }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Education</dt>
                                <dd class="mt-1 text-sm text-gray-900 whitespace-pre-line">{{ $application->education ?? 'Not provided' }}</dd>
                            </div>
                            @if($application->cover_letter)
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Cover Letter</dt>
                                <dd class="mt-1 text-sm text-gray-900 whitespace-pre-line">{{ $application->cover_letter }}</dd>
                            </div>
                            @endif
                        </div>
                    </div>
