                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex items-end">
                                <button
                                    class="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md transition-colors duration-200">
                                    Search
                                </button>
                            </div>
                        </div>
                                ...
                                <div
                                    ...
                                    @if ($company->banner)
                                        <div class="h-32 bg-cover bg-center"
                                            style="background-image: url('{{ $company->banner_url }}')"></div>
                                    @else
                                        ...
                                        <div class="space-y-2 mb-4">
                                            ...
                                            @if ($company->website)
                                                <div class="flex items-center text-gray-600">
                                                    ...
                                                    <span
                                                        class="text-sm">{{ parse_url($company->website, PHP_URL_HOST) }}</span>
                                                </div>
                                            @endif
