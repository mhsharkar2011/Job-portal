            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <form action="{{ route('companies.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Company Name -->
                        <div class="md:col-span-2">
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Company Name
                                *</label>
                            ...
                            <select id="industry" name="industry"
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->name }}"
                                        {{ old('industry', $company->industry ?? '') == $category->name ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                        ...
                        <div id="custom_industry_container" class="mt-4 hidden">
                            <label for="custom_industry" class="block text-sm font-medium text-gray-700 mb-2">Custom Industry</label>
                        ...
                        <!-- About Company -->
                        <div class="md:col-span-2">
                            <label for="about" class="block text-sm font-medium text-gray-700 mb-2">About
                                Company</label>
                        ...
                        <!-- Employees Count -->
                        <div>
                            <label for="employees_count" class="block text-sm font-medium text-gray-700 mb-2">Number of
                                Employees</label>
                            <select id="employees_count" name="employees_count"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="">Select Range</option>
                                <option value="1" {{ old('employees_count') == '1' ? 'selected' : '' }}>1-10</option>
                                <option value="11" {{ old('employees_count') == '11' ? 'selected' : '' }}>11-50
                                </option>
                                <option value="51" {{ old('employees_count') == '51' ? 'selected' : '' }}>51-200
                                </option>
                                <option value="201" {{ old('employees_count') == '201' ? 'selected' : '' }}>201-500
                                </option>
                                <option value="501" {{ old('employees_count') == '501' ? 'selected' : '' }}>501-1000
                                </option>
                                <option value="1001" {{ old('employees_count') == '1001' ? 'selected' : '' }}>1000+
                                </option>
                            </select>
                        </div>
                        ...
                        <!-- Founded Year -->
                        <div>
                            <label for="founded_year" class="block text-sm font-medium text-gray-700 mb-2">Founded
                                Year</label>
                        ...
                        <!-- Logo -->
                        <div>
                            <label for="logo" class="block text-sm font-medium text-gray-700 mb-2">Company
                                Logo</label>
                        ...
                        <!-- Banner -->
                        <div>
                            <label for="banner" class="block text-sm font-medium text-gray-700 mb-2">Company
                                Banner</label>
